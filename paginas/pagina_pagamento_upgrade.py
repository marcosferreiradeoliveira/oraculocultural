...
def pagina_pagamento_upgrade():
    ...
    is_test_environment = mp_access_token.startswith("TEST-")
    ...
    if is_test_environment:
        ...
        if current_user_email == seller_test_email:
            ...
            Você está logado como **{current_user_email}**, que é o email da conta **VENDEDORA** de teste.
            O Mercado Pago **não permite que o vendedor pague a si mesmo.**

            **Para testar o pagamento corretamente:**
        ...
        Você está no ambiente de produção do Mercado Pago.
        As transações serão reais e poderão gerar cobranças.
        """)
